...
```{python}
(37.542133+5.912801)/2
```

```{python}
(43.576555+4.550033)/2
```

```{python}
(177.678781+3.093487)/2
```

```{python}
(32.276606+4.118974)/2
```

```{python}
(24.712070+2.488569)/2
```

```{python}
objects = ("Block A", 'Block B', 'Block C', 'Block G', 'Block YG')
y_pos = np.arange(len(objects))
performance = [21.727467, 24.063294, 90.386134, 18.19779, 13.600319500000001]

plt.bar(y_pos, performance, align='center', alpha=0.5)
plt.xticks(y_pos, objects)
plt.ylabel('Amount of ____')
